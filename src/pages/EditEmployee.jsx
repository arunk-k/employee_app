...
const EditEmployee = () => {
    ...
    const [data, setData] = useState({ name: '', department: '', age: '', address: '', email: '', phone: '', id: '' });
    ...
    const handleSubmit = () => {
        const employeeExisting = employees.find(item => (item.email == data.email || item.phone == data.phone) && item.id != data.id)
                        ...
                        loading
                            ...
                            <>
                                ...
                                <div className='d-flex justify-content-center gap-3 mt-4'>
                                    <button style={{ backgroundColor: "#01607a" }} onClick={handleSubmit} className="btn btn-light text-light mb-4 px-4">Update</button>
